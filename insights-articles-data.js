...
window.INSIGHT_ARTICLES = [
  {
    ...
    num: "2", title: "Cracking guesstimates", readTime: "2 MIN READ", tag: "THE MINDSET", accent: "#ff5a3c",
    body: [
  ...
  {
    slug: "rca-mindset",
    num: "3", title: "Writing a killer RCA", readTime: "2 MIN READ", tag: "THE METHOD", accent: "#c6f24e",
    body: [
  ...
  {
    slug: "interview-loop",
    num: "4", title: "Acing the PM interview loop", readTime: "2 MIN READ", tag: "THE CHECKLIST", accent: "#2f9e44",
    body: [
  ...
  {
    slug: "saying-no",
    num: "5", title: "The mistake that taught me to say no", readTime: "2 MIN READ", tag: "ON FOCUS", accent: "#5b2fe0",
    body: [
  ...
  {
    slug: "first-90-days",
    num: "6", title: "What nobody tells you about your first 90 days", readTime: "2 MIN READ", tag: "STARTING STRONG", accent: "#ff5a3c",
    body: [
  ...
  },
  {
    ...
    num: "7", title: "From features to outcomes", readTime: "1 MIN READ", tag: "MINDSET", accent: "#c6f24e",
    body: [
  ...
  {
    slug: "managing-up",
    num: "8", title: "Managing up without losing yourself", readTime: "2 MIN READ", tag: "STAKEHOLDERS", accent: "#5b2fe0",
    body: [
  ...
  {
    slug: "i-dont-know",
    num: "9", title: "Why 'I don't know' is a superpower", readTime: "1 MIN READ", tag: "CRAFT", accent: "#ff5a3c",
    body: [
  ...
  {
    slug: "flopped-launch",
    num: "10", title: "The launch that flopped, and what it gave me", readTime: "1 MIN READ", tag: "FAILURE", accent: "#c6f24e",
    body: [
  ...
  },
  {
    ...
    num: "11", title: "Influence without authority", readTime: "1 MIN READ", tag: "LEADERSHIP", accent: "#5b2fe0",
    body: [
  ...
  {
    slug: "quiet-habits",
    num: "12", title: "The quiet habits that made me better", readTime: "2 MIN READ", tag: "HABITS", accent: "#ff5a3c",
    body: [
