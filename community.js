...
(function () {
  ...
  function renderAccount() {
    ...
    if (u && !u.needsProfile) {
      ...
      if (SNAuth.isAdmin()) acctMenu.appendChild(menuItem('🛠  Admin', function () { location.href = 'Portfolio.dc.html#admin'; }));
  ...
  function buildCommunity() {
    return; /* retired: the standalone forum page is no longer part of the site */
    if (commBtn) return;
